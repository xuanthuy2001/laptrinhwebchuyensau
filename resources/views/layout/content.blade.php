                        ...
                        <div class="col-lg-6">
                              <div class="card widget-flat">
                                    <div class="card-body">
                                          ...
                                          <h5 class="text-muted font-weight-normal mt-0" title="Number of Orders">Orders
                                          </h5>
                        ...
                        <div class="col-lg-6">
                              <div class="card widget-flat">
                                    <div class="card-body">
                                          ...
                                          <h5 class="text-muted font-weight-normal mt-0" title="Average Revenue">Revenue
                                          </h5>
                        ...
                        <div class="card-body">
                              ...
                              <div class="chart-content-bg">
                                    <div class="row text-center">
                                          ...
                                          <div class="col-md-6">
                                                <p class="text-muted mb-0 mt-3">Previous Week
                                                </p>
                                                <h2 class="font-weight-normal mb-3">
                                                      <small
                              ...
                              <div class="dash-item-overlay d-none d-md-block">
                                    ...
                                    <p class="text-muted font-13 mb-3 mt-2">Etiam ultricies nisi
                                    ...
                                    <div class="timeline-alt pb-0">
                                          <div class="timeline-item">
                                                ...
                                                <div class="timeline-item-info">
                                                      <a href="#" class="text-info font-weight-bold mb-1 d-block">You
                                                            sold an item</a>
                                                      <small>Paul Burgess just purchased “Hyper
                                                            - Admin Dashboard”!</small>
                                                      <p class="mb-0 pb-2">
                                                            <small class="text-muted">5 minutes
                                                                  ago</small>
                                                      </p>
                                                </div>
                                          </div>
                                          ...
                                          <div class="timeline-item">
                                                ...
                                                <div class="timeline-item-info">
                                                      ...
                                                      <p class="mb-0 pb-2">
                                                            <small class="text-muted">30 minutes
                                                                  ago</small>
                                                      </p>
                                                </div>
                                          </div>
                                          ...
                                          <div class="timeline-item">
                                                ...
                                                <div class="timeline-item-info">
                                                      ...
                                                      <p class="mb-0 pb-2">
                                                            <small class="text-muted">14 hours
                                                                  ago</small>
                                                      </p>
                                                </div>
                                          </div>
                                          ...
                                          <div class="timeline-item">
                                                ...
                                                <div class="timeline-item-info">
                                                      ...
                                                      <small>Paul Burgess just purchased “Hyper
                                                            - Admin Dashboard”!</small>
                                                      <p class="mb-0 pb-2">
                                                            <small class="text-muted">16 hours
                                                                  ago</small>
                                                      </p>
                                                </div>
                                          </div>
                                          ...
                                          <div class="timeline-item">
                                                ...
                                                <div class="timeline-item-info">
                                                      ...
                                                      <p class="mb-0 pb-2">
                                                            <small class="text-muted">22 hours
                                                                  ago</small>
                                                      </p>
                                                </div>
                                          </div>
